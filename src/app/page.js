...
export default function HomeCep() {
    ...
    const [cepBlur, setCepBlur] = useState(false);
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex items-center justify-center">
            <form className="w-full max-w-md bg-white p-6 rounded-xl shadow-md flex flex-col gap-3">
                ...
                <input className="rounded-md border border-gray-300 px-3 py-2 text-sm" type="text" name="cep" placeholder="CEP" value={endereco.cep} onChange={handleChange} onBlur={campoCep}/>
